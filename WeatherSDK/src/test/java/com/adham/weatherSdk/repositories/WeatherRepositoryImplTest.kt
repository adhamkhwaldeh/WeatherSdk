...
class WeatherRepositoryImplTest {
    ...
    @Test
    fun `current should call apiService when apiKey is not blank`() = runBlocking {
        // Arrange
        val city = "London"
    ...
    @Test
    fun `current should call mockedApiService when apiKey is blank`() = runBlocking {
        // Arrange
        val city = "London"
        val apiKey = ""
        val expectedResponse = mockk<CurrentWeatherResponse>()
    ...
    @Test
    fun `current should return failure when apiService throws exception`() = runBlocking {
        // Arrange
        val city = "London"
        val apiKey = "valid_api_key"
    ...
    @Test
    fun `forecast should call apiService when apiKey is not blank`() = runBlocking {
        // Arrange
        val city = "London"
        val hours = 24
        val apiKey = "valid_api_key"
    ...
    @Test
    fun `forecast should call mockedApiService when apiKey is blank`() = runBlocking {
        // Arrange
        val city = "London"
        val hours = 24
        val apiKey = ""
    ...
    @Test
    fun `forecast should return failure when apiService throws exception`() = runBlocking {
        // Arrange
        val city = "London"
        val hours = 24
        val apiKey = "valid_api_key"
